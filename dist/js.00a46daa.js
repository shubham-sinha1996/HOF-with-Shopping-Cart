...
currencyPicker.innerHTML = Object.keys(_currencyRates.default).map(el => `<option>${el}</option>`).join('');
...
const computeCart = function () {
  ...
  computeCurrencyChange(currency, _currencyRates.default, _view.renderRows)(_cart.default);
  computeCurrencyChange(currency, _currencyRates.default, _view.renderTotals)(_cart.default);
};
